...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.ngOnInit = function () {
        ...
        this.searchTerm.valueChanges.subscribe(function (term) {
            if (term !== '') {
                _this.searchService.fetchData(term).subscribe(function (res) { return _this.searchs = res; });
            }
        });
    };
...
var SearchService = /** @class */ (function () {
    ...
    SearchService.prototype.fetchData = function (keyword) {
        var apiUri = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUri + "/search?query=" + keyword;
...
module.exports = __webpack_require__(/*! D:\05-Internal_project\02.githubFE\searching-FE\src\main.ts */"./src/main.ts");
